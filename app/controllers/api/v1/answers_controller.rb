    ...
    class AnswersController < ApplicationController
      ...
      def index
        ...
        @answers.each do |answer|
          ...
          @allanswers.push({ id: answer.id, question: @question.title, answer: answer.title, created: answer.created_at, author: @user.name, comments: answer.comments.count, votes: answer.votes.count })
        end
      ...
      def show
        ...
        render json: { id: @answer.id, question: @answer.question.title, answer: @answer.title, created: @answer.created_at, author: @answer.user.name, votes: @answer.votes.count, comments: @comment }
      end
